function getLazarSoftScanner() {
    ...
    function r(e, t, n, r, i, a) {
        ...
        (this.totalCodewords = o),
            ...
            (this.buildFunctionPattern = function () {
                ...
                for (
                    var n = this.alignmentPatternCenters.length, r = 0;
                    r < n;
                    r++
                )
                    for (
                        var i = this.alignmentPatternCenters[r] - 2, a = 0;
                        a < n;
                        a++
                    )
                        (0 == r && (0 == a || a == n - 1)) ||
    ...
    function w(e) {
        (this.errorCorrectionLevel = f.forBits((e >> 3) & 3)),
            ...
            (this.GetHashCode = function () {
                return (
                    (this.errorCorrectionLevel.ordinal() << 3) | this.dataMask
                );
            }),
                    ...
                    for (var u = 0; u < r; u++)
                        for (var d = a ? r - 1 - u : u, l = 0; l < 2; l++)
                            i.get_Renamed(f - l, d) ||
                                (w++,
                                (h <<= 1),
                                this.bitMatrix.get_Renamed(f - l, d) &&
                                    (h |= 1),
                                8 == w && ((o[s++] = h), (w = 0), (h = 0)));
                    a ^= !0;
                }
            ...
            (this.multiply1 = function (e) {
                ...
                for (
                    ...
                    for (var s = t[o], h = 0; h < i; h++)
                        a[o + h] = _.addOrSubtract(
                            a[o + h],
                            this.field.multiply(s, r[h])
                        );
        ...
        (this.field = e),
                ...
                for (
                    ...
                    for (
                        ...
                        var v = a.Degree - i.Degree,
                            m = this.field.multiply(
                                a.getCoefficient(a.Degree),
                                g
                            );
            ...
            (this.findErrorMagnitudes = function (e, t, n) {
                for (var r = t.length, i = new Array(r), a = 0; a < r; a++) {
                    for (
                        var o = this.field.inverse(t[a]), s = 1, h = 0;
                        h < r;
                        h++
                    )
                        a != h &&
                    ...
                    (i[a] = this.field.multiply(
                        e.evaluateAt(o),
                        this.field.inverse(s)
                    )),
    ...
    (A.imagedata = null),
                    ...
                    navigator.mediaDevices
                        ...
                        .then(function (e) {
                            e.forEach(function (e) {
                                console.log("deb1"),
                                    "videoinput" === e.kind &&
                                        e.label.toLowerCase().search("back") >
                                            -1 &&
                                        (n = [
                                            {
                                                sourceId: e.deviceId,
        ...
        (A.decode = function (e) {
            if (0 == arguments.length) {
                if (A.canvas_qr2)
                    ...
                    n = (t = document.getElementById("qr-canvas")).getContext(
                        "2d"
                    );
                return (
                    (A.width = t.width),
            ...
            (r.crossOrigin = "Anonymous"),
                ...
                (r.onerror = function () {
                    null != A.callback &&
                        A.callback("Failed to load the image");
                }),
                (r.src = e);
        }),
        (A.isUrl = function (e) {
        ...
        (A.process = function (e) {
                ...
                for (var r = 0; r < A.height; r++)
                    for (var i = 0; i < A.width; i++) {
                        ...
                        (A.imagedata.data[a] = (n[i + r * A.width], 0)),
                            ...
                            (A.imagedata.data[a + 2] = n[i + r * A.width]
                                ? 255
                                : 0);
                    }
                ...
                for (r = 0; r < s.bits.Height; r++)
                    for (i = 0; i < s.bits.Width; i++) {
                        ...
                        (A.imagedata.data[a] = (s.bits.get_Renamed(i, r), 0)),
                            (A.imagedata.data[a + 1] =
                                (s.bits.get_Renamed(i, r), 0)),
                            (A.imagedata.data[a + 2] = s.bits.get_Renamed(i, r)
                                ? 255
                                : 0);
                    }
                e.putImageData(A.imagedata, 0, 0);
            ...
            for (
                var h = p.decode(s.bits).DataByte, w = "", f = 0;
                f < h.length;
                f++
            )
        ...
        (A.binarize = function (e) {
            for (
                var t = new Array(A.width * A.height), n = 0;
                n < A.height;
                n++
            )
    ...
    function D() {
        (this.image = null),
            ...
            (this.selectBestPatterns = function () {
                ...
                if (e < 3)
                    throw (
                        "Couldn't find enough finder patterns (found " + e + ")"
                    );
                if (e > 3) {
                        ...
                        if (e[f + w * A.width])
                            if (1 == u) s[u]++;
                                ...
                                if (this.foundPatternCross(s))
                                    if (
                                        null !=
                                        (d = this.handlePossibleCenter(s, w, f))
                                    )
                                        return d;
        ...
        (this.blockPointer = 0),
            ...
            (this.getDataLength = function (e) {
                ...
                return this.getNextBits(
                    A.sizeOfDataLengthInfo[this.dataLengthMode][t]
                );
            }),
